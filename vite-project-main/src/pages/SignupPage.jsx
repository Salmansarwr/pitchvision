  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      try {
        ...
        // You could set a form-level error state here to display to the user
      }
    } else {
      // Form has errors
          ...
          <div className="p-8">
            {formSuccess ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-300 mb-6">Your account has been successfully created. You will be redirected to the dashboard shortly.</p>
              ...
              <>
                <div className="text-center mb-8">
                  <h1 className="text-3xl font-bold mb-2">
                    Create an <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Account</span>
                  </h1>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-gray-400 text-sm font-medium mb-1" htmlFor="firstName">
                    First Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-3 py-2 bg-gray-700 border ${formErrors.firstName ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                  />
                  {formErrors.firstName && <p className="text-red-500 text-xs mt-1">{formErrors.firstName}</p>}
                </div>
                <div>
                  <label className="block text-gray-400 text-sm font-medium mb-1" htmlFor="lastName">
                    Last Name *
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={handleChange}
                    className={`w-full px-3 py-2 bg-gray-700 border ${formErrors.lastName ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                  />
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 bg-gray-700 border ${formErrors.confirmPassword ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                />
                {formErrors.confirmPassword && <p className="text-red-500 text-xs mt-1">{formErrors.confirmPassword}</p>}
              </div>
              
              <div className="mb-6">
                <label className="block text-gray-400 text-sm font-medium mb-1" htmlFor="teamName">
                  Team Name *
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 bg-gray-700 border ${formErrors.teamName ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                />
