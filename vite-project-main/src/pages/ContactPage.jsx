  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:8000/api/videos/contact/",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white flex flex-col">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Have questions about Pitch Vision? We're here to help! Reach out to
            our team for information about our products, services, or
          ...
          <div className="lg:w-1/3">
            ...
            <div className="bg-gray-800 rounded-xl p-8 shadow-xl border border-gray-700">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="#"
                  className="bg-indigo-900 hover:bg-indigo-800 transition p-4 rounded-lg text-center flex flex-col items-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-900 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">
                  Pitch Vision Headquarters
                </h3>
                <p className="text-gray-300">
                  Bahria University, Shangrila Road, Sector E-8, Islamabad
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="faq" className="container mx-auto px-4 pb-16">
        ...
        <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-xl font-semibold mb-3 text-white">
              What video formats does Pitch Vision support?
            </h3>
            <p className="text-gray-300">
              Pitch Vision supports standard video formats including MP4, AVI,
              and MOV. For best results, we recommend HD resolution (1920x1080)
              at 30 FPS.
            </p>
          </div>
          ...
          < div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-xl font-semibold mb-3 text-white">
              How accurate is the player tracking?
            </h3>
            <p className="text-gray-300">
              Our YOLO-based tracking system achieves over 95% accuracy in
              identifying and tracking players, the ball, and referees across
          ...
          <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-xl font-semibold mb-3 text-white">
              What metrics does Pitch Vision track?
            </h3>
            <p className="text-gray-300">
              We track comprehensive metrics including player positions, speeds, distances covered, passing accuracy, possession statistics, tactical formations, and key events like goals and shots.
            </p>
          </div>

          <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            <h3 className="text-xl font-semibold mb-3 text-white">
              Is the analysis data exportable?
            </h3>
            <p className="text-gray-300">
              Yes! All analysis data can be exported in multiple formats including JSON, and PDF reports for further analysis. You can download complete match reports directly from the platform.
            </p>
          </div>
        </div>
      </section>
